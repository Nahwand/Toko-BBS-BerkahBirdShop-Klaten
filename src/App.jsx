      ...
      <div className="bbs-main">
        ...
        <div className="bbs-content">
          ...
          <PageErrorBoundary pageName="Produk" key={`produk-${page}`}>
            {page === "produk" && <ProdukPage filtProd={filtProd} suppliers={suppliers} searchProd={searchProd} setSearchProd={setSearchProd} filterCat={filterCat} setFilterCat={setFilterCat} kategoris={kategoris} setProdForm={setProdForm} setProdImage={setProdImage} setProdModal={setProdModal} delProd={delProd} currentUser={currentUser} />}
          </PageErrorBoundary>
