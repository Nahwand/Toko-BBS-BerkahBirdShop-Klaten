  ...
  return (
    <div>
      <div className="flex gap-2 mb-4 flex-wrap">
        ...
        <button className="ml-auto px-4 py-1.5 rounded-lg text-xs font-bold bg-bbs-green text-white border-none cursor-pointer"
      ...
      <div className="bg-white dark:bg-[#1a2a1a] rounded-xl border border-bbs-border dark:border-[#2d4a2d] overflow-auto">
