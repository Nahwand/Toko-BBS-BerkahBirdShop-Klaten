      ...
      <div className={styles.modal} style={{ width: 320 }} onClick={(e) => e.stopPropagation()}>
        <div id="struk-print">
          ...
          <div style={{ textAlign: "center", marginBottom: 8 }}>
            ...
            <div style={{ fontSize: 9, color: "#666" }}>{receipt.trx_code} &middot; {receipt.date || TODAY}</div>
          ...
          <table style={{ width: "100%", fontSize: 10, borderCollapse: "collapse" }}>
            <tbody>
              <tr>
                ...
                <td style={{ fontWeight: 900, fontSize: 13, textAlign: "right", color: "#2d7a2d", paddingBottom: 3 }}>{fmt(receipt.total)}</td>
              </tr>
              <tr>
                <td style={{ color: "#555" }}>Bayar</td>
                <td style={{ textAlign: "right", color: "#555" }}>{fmt(receipt.payment)}</td>
              </tr>
              <tr>
                <td style={{ fontWeight: 700 }}>Kembalian</td>
                <td style={{ textAlign: "right", fontWeight: 700 }}>{fmt(receipt.change_amt)}</td>
              </tr>
            </tbody>
          </table>
