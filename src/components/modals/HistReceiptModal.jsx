      ...
      <div className={styles.modal} style={{ width: 320 }} onClick={(e) => e.stopPropagation()}>
        <div id="struk-print">
          <div style={{ textAlign: "center", marginBottom: 8 }}>
            ...
            <div style={{ fontSize: 9, color: "#666" }}>{histReceipt.trx_code} · {histReceipt.date}</div>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", fontWeight: 900, fontSize: 13, padding: "3px 0" }}>
            <span>TOTAL</span>
            <span style={{ color: "#2d7a2d", whiteSpace: "nowrap" }}>{fmt(histReceipt.total)}</span>
          </div>
          <div style={{ display: "flex", justifyContent: "space-between", fontSize: 10, padding: "2px 0" }}>
            <span>Bayar</span><span style={{ whiteSpace: "nowrap" }}>{fmt(histReceipt.payment)}</span>
          </div>
          <div style={{ display: "flex", justifyContent: "space-between", fontSize: 10, padding: "2px 0" }}>
            <span>Kembalian</span><strong style={{ whiteSpace: "nowrap" }}>{fmt(histReceipt.change_amt)}</strong>
          </div>
